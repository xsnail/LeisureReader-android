...
public class ThemeManager {
    ...
    public static Bitmap getThemeDrawable(int theme) {
        ...
        switch (theme) {
            case NORMAL:
                bmp.eraseColor(ContextCompat.getColor(App.getInstance(), R.color.read_theme_white));
                break;
            case YELLOW:
                bmp.eraseColor(ContextCompat.getColor(App.getInstance(), R.color.read_theme_yellow));
                break;
            case GREEN:
                bmp.eraseColor(ContextCompat.getColor(App.getInstance(), R.color.read_theme_green));
                break;
            case LEATHER:
                bmp = BitmapFactory.decodeResource(App.getInstance().getResources(), R.drawable.theme_leather_bg);
                break;
            case GRAY:
                bmp.eraseColor(ContextCompat.getColor(App.getInstance(), R.color.read_theme_gray));
                break;
            case NIGHT:
                bmp.eraseColor(ContextCompat.getColor(App.getInstance(), R.color.read_theme_night));
                break;
            default:
                break;
        }
