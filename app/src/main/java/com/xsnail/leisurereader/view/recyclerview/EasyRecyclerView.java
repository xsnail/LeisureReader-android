 ...
 */
package com.xsnail.leisurereader.view.recyclerview;
...
import com.xsnail.leisurereader.view.recyclerview.decoration.DividerDecoration;
import com.xsnail.leisurereader.view.recyclerview.swipe.OnRefreshListener;
import com.xsnail.leisurereader.view.recyclerview.swipe.SwipeRefreshLayout;
...
public class EasyRecyclerView extends FrameLayout {
    ...
    public static class EasyDataObserver extends AdapterDataObserver {
        ...
        private void update() {
            ...
            if (count == 0 && !NetUtils.isAvailable(recyclerView.getContext())) {
