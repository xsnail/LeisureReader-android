...
public class UploadPdfHandler implements IResourceUrlHandler {
    private static final String TAG = "UploadPdfHandler";
    private String acceptPrefix = "/upload_pdf/";
    ...
    public void handle(String uri, HttpContext httpContext) throws IOException {
        ...
        String tmpPath = FileUtils.createRootPath(App.getInstance()) + "/hello.pdf";
        ...
        // 创建目标文件
        File desc = FileUtils.createWifiTranfesPdfFile(fileName);
